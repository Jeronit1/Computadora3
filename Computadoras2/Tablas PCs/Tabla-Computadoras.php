...
?>
        ...
        <section>
            ...
            ?>
                ...
                ?>
                        ...
                        ?>
                            <div class="editar"><a href="../Tablas PCs/actualizar.php?ID=<?php echo $mostrar["ID"]; ?>">Editar/</a>      
        ...
        ?>
            ...
            ?>
                ...
                <button  onclick="location.href='../Agregar PCs/Formulario.php'">Anexar</button><!-- boton que lleva a anexar un nuevo usuario-->
