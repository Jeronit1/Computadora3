...
if (((empty($_SESSION["Email"])))) {
    header("location: /computadoras2/Login/Login.php");
} else {
?>
<!DOCTYPE html>
<html lang="es">
...
<div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <ul>
                    ...
                    ?>
                        <li><a href="../computadoras2/Tablas PCs/Usuarios_logeados.php?pagina=1"> <span class="icon"><i class="bi bi-people-fill"></i> </span>
